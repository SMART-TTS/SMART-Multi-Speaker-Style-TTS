  ...
  for batch_idx, (x, x_lengths, mel, mel_lengths, spec, spec_lengths, y, y_lengths, tag_emb, sid) in enumerate(train_loader):
    ...
    with autocast(enabled=hps.train.fp16_run):
      ...
      mel_ = spec_to_mel_torch(
          ...
          hps.data.mel_fmin,
          hps.data.mel_fmax)
      y_mel = commons.slice_segments(mel_, ids_slice, hps.train.segment_size // hps.data.hop_length)
...
#      if global_step % 1 == 0:
        ...
        image_dict = { 
            ...
            "all/mel": utils.plot_spectrogram_to_numpy(mel_[0].data.cpu().numpy()),
...
#      "gen/audio_tag": y_hat_tag[0,:,:y_hat_lengths[0]]
    ...
    if global_step == 0:
      image_dict.update({"gt/mel": utils.plot_spectrogram_to_numpy(mel_[0].cpu().numpy())})
